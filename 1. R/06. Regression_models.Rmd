...
models_df <- tribble(
  ...
  NA,                     "Lasso L1",     FALSE,
  NA,                     "Ridge L2",     FALSE,
  my_XGBoost_model,       "XGBoost",      TRUE,
  my_LightGBM_model,      "LightGBM",     TRUE,
  my_Catboost_model,      "CatBoost",     TRUE,
  my_RandomForest_model,  "Random Forest",TRUE,
  my_knn_model,           "kNN",          TRUE,
  my_SVR_model,           "SVR",          TRUE
) %>% as.data.table()
```
