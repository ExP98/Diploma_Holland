...
```{r}
rf <- randomForest(x = X_train, y = as.factor(Y_b_train[, 1]), ntree = 1000, importance = TRUE) 

predict(rf, X_test, type = "prob")[, "TRUE"]
# потом из вектора с 6 значениями выбирать те 3, где максимальная вероятность
```
