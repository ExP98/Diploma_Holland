...
perform_indep_multioutput_regression <- function(model_class, print_msg = "", 
  ...
  if (print_metric) print(show_custom_metrics(ind_pred, paste0(print_msg, " Indep")))
...
perform_chain_multioutput_regression <- function(model_class, print_msg = "", 
  ...
  if (print_metric) print(show_custom_metrics(chain_pred, paste0(print_msg, " Chained")))
...
scalar_matrix_production(w_vec = w, models_pred) %>% show_custom_metrics("All")
```
...
w <- c(1, 5, 5, 5, 1, 2, 6)
scalar_matrix_production(w_vec = w, selected_models_pred) %>% show_custom_metrics("Selected")
```
...
scalar_matrix_production(w_vec = w, selected2_models_pred) %>% show_custom_metrics("Selected 2")
```
