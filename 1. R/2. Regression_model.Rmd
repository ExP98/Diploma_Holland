...
```{r}
perform_stack_MO_regression(my_XGBoost_model, X_train, Y_train, X_test, Y_test, T)
```
...
perform_stack_MO_regression(my_knn_model, X_train, Y_train, X_test, Y_test, T, k = 2)
perform_stack_MO_regression(my_knn_model, X_train, Y_train, X_test, Y_test, T, k = 3)
perform_stack_MO_regression(my_knn_model, X_train, Y_train, X_test, Y_test, T, k = 5)
perform_stack_MO_regression(my_knn_model, X_train, Y_train, X_test, Y_test, T, k = 7)
perform_stack_MO_regression(my_knn_model, X_train, Y_train, X_test, Y_test, T, k = 10)
perform_stack_MO_regression(my_knn_model, X_train, Y_train, X_test, Y_test, T, k = 15)
```
